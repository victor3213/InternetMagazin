...
@section('add-a-product')
  ...
  <form action="{{ route('saveProd') }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <p for="cars">Alege categoria:</p>
      ...
      <option value="Roboti">Roboti</option>
    ...
    <p>Numele produsului: <input type="text" name="nameProd"></p>
    <p>Pretul produsului: <input type="text" name="priceProd"></p>
    <p>Inormatii <br> <textarea name="informationProd" style="width:600px; height:200px;"></textarea></p>
    <p>Imaginea: <input type="file" name="image"></p>
